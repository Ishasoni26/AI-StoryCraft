...
import { Wand2, Play, Sparkles, Video, Pause, AlertCircle, Download, Loader2, Edit3, ChevronRight, CheckCircle2, Image as ImageIcon, Globe, Mail, Link, XCircle, MessageSquare, Mic, Scissors, Zap, Music, Smartphone, Settings, PenTool, Volume2, Type, FileText, Users, Plus, Trash2 } from 'lucide-react';
  ...
  const handleGenerateStoryboard = async () => {
    ...
    try {
      const res = await fetch('/api/generate', {
        method: 'POST',
        body: JSON.stringify({ script, targetLanguage, characterProfile, locationProfile, characters }),
        headers: { 'Content-Type': 'application/json' }
      });
      const data = await res.json();
